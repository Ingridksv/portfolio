---
title: "Systemudvikling 2.0"
date: 2026-06-11
weight: 110
topic: "Systemudvikling 2.0"
...
- [1. Kort kerneforklaring](#1-kort-kerneforklaring)
- [2. Hvad indeholder Scrum?](#2-hvad-indeholder-scrum)
  - [Roller i Scrum](#roller-i-scrum)
  - [Min rolle som Developer](#min-rolle-som-developer)
  - [Events i Scrum](#events-i-scrum)
  - [Artefakter i Scrum](#artefakter-i-scrum)
- [3. Agile vs. Scrum](#3-agile-vs-scrum)
- [4. Scrum sammenlignet med Waterfall](#4-scrum-sammenlignet-med-waterfall)
- [5. Backlog](#5-backlog)
- [6. INVEST](#6-invest)
- [7. Artefakter er gode at have – hvis de bruges rigtigt](#7-artefakter-er-gode-at-have--hvis-de-bruges-rigtigt)
- [8. Scrum Board – ikke Taiga Board](#8-scrum-board--ikke-taiga-board)
- [9. Refleksion til eksamen](#9-refleksion-til-eksamen)
- [10. Korte svar](#10-korte-svar)
- [11. Mulige spørgsmål til eksamen](#11-mulige-spørgsmål-til-eksamen)
- [12. Afslutning](#12-afslutning)
- [13. Begrebsoversigt i alfabetisk orden](#13-begrebsoversigt-i-alfabetisk-orden)
...
I Scrum er Developers ikke kun dem, der skriver kode. Developers er hele teamet, der arbejder med at skabe et færdigt increment i sprintet. Det kan derfor både være analyse, design, frontend, backend, test, dokumentation og kvalitetssikring.

Som Developer havde jeg ansvar for at bidrage til sprintets arbejde og være med til at omsætte backlog items til konkrete løsninger. I CareBridge arbejdede jeg især med frontend/backend-forståelse, analyse af data og roller, adgangsstyring og refleksion over hvordan funktionalitet skulle give værdi for brugeren.

En vigtig læring for mig var, at Developer-rollen ikke kun handler om at “tage en opgave og kode den”. Den handler også om at forstå brugerbehov, stille spørgsmål, samarbejde med teamet, følge Definition of Done og sikre, at arbejdet faktisk bidrager til sprintmålet.

> Som Developer lærte jeg, at teknisk arbejde og proces hænger sammen. Hvis backloggen, kravene eller Definition of Done er uklare, bliver det også sværere at udvikle en god løsning.
...
## 11. Mulige spørgsmål til eksamen
...
## 13. Begrebsoversigt i alfabetisk orden

### Hurtig navigation til begreber

- [Agile](#agile)
- [Definition of Done](#definition-of-done)
- [Developers](#developers)
- [Increment](#increment)
- [INVEST](#invest-begreb)
- [Product Backlog](#product-backlog-begreb)
- [Product Owner](#product-owner)
- [Retrospective](#retrospective)
- [Review](#review)
- [Scrum](#scrum-begreb)
- [Scrum Board](#scrum-board-begreb)
- [Scrum Master](#scrum-master)
- [Sprint](#sprint-begreb)
- [Sprint Backlog](#sprint-backlog-begreb)
- [User Story](#user-story)

| Begreb | Kort forklaring |
|---|---|
| <a id="agile"></a>Agile | Tankegang om fleksibel og iterativ udvikling. |
| <a id="definition-of-done"></a>Definition of Done | Fælles aftale om hvornår noget er færdigt. |
| <a id="developers"></a>Developers | Teamet der skaber incrementet. |
| Developers | Teamet der skaber incrementet; kan arbejde med kode, analyse, test, design og dokumentation. |
| <a id="increment"></a>Increment | Det færdige produktbidrag efter sprintet. |
| <a id="invest-begreb"></a>INVEST | Kriterier for gode user stories. |
| <a id="product-backlog-begreb"></a>Product Backlog | Prioriteret liste over alt arbejde i produktet. |
| <a id="product-owner"></a>Product Owner | Prioriterer backlog og maksimerer produktværdi. |
| <a id="retrospective"></a>Retrospective | Refleksion over processen. |
| <a id="review"></a>Review | Feedback på produktet. |
| <a id="scrum-begreb"></a>Scrum | Agilt framework med roller, events og artefakter. |
| <a id="scrum-board-begreb"></a>Scrum Board | Visuel oversigt over sprintets arbejde. |
| <a id="scrum-master"></a>Scrum Master | Understøtter Scrum-processen og fjerner forhindringer. |
| <a id="sprint-begreb"></a>Sprint | Fast periode hvor teamet arbejder mod et mål. |
| <a id="sprint-backlog-begreb"></a>Sprint Backlog | Opgaver valgt til det aktuelle sprint. |
| <a id="user-story"></a>User Story | Beskrivelse af brugerbehov og værdi. |